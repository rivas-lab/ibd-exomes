...
mt_1kg = hl.experimental.load_dataset(
    name="1000_Genomes_autosomes", version="phase_3", reference_genome="GRCh38"
)
print(mt_1kg.count())
...
mt = mt.select_cols(
    ...
    mt.sample_qc.n_called,
    mt.sample_qc.n_not_called,
    mt.sample_qc.n_hom_ref,
    mt.sample_qc.n_het,
    mt.sample_qc.n_hom_var,
    mt.sample_qc.n_non_ref,
...
mt_1kg = mt_1kg.select_cols(
    mt_1kg.sample_qc.call_rate,
    mt_1kg.sample_qc.n_called,
    mt_1kg.sample_qc.n_not_called,
    mt_1kg.sample_qc.n_hom_ref,
    mt_1kg.sample_qc.n_het,
    mt_1kg.sample_qc.n_hom_var,
    mt_1kg.sample_qc.n_non_ref,
    mt_1kg.sample_qc.n_singleton,
    mt_1kg.sample_qc.n_snp,
    mt_1kg.sample_qc.n_insertion,
    mt_1kg.sample_qc.n_deletion,
    mt_1kg.sample_qc.n_transition,
    mt_1kg.sample_qc.n_transversion,
    mt_1kg.sample_qc.n_star,
    mt_1kg.sample_qc.r_ti_tv,
    mt_1kg.sample_qc.r_het_hom_var,
    mt_1kg.sample_qc.r_insertion_deletion,
)
...
eigenvalues, scores, loadings = hl.hwe_normalized_pca(
    kg_mt.GT, k=10, compute_loadings=True
)
...
projections.export("gs://ibd-exomes/v36meta/1kg_pca_projections_all_samples.tsv.gz")
